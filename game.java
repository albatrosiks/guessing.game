    ...
    public static void main(String[] args) {
        ...
        while (maxTry > 0 && indexMatch != 4) {
            ...
            for (int i = 0; i < guess.length; i++) {
                if (guess[i] == random[i]) {
                    indexMatch++;
                } else if (guess[i] == random[0] || guess[i] == random[1] || guess[i] == random[2]
                        || guess[i] == random[3]) {
                    match++;
                }
            }
            if (indexMatch == 4) {
                ...
                maxTry--;
                if (maxTry > 1) {
                    System.out.println("You have guess " + "M:" + indexMatch + "; " + "P:" + match);
                    System.out.println(maxTry + " " + " attempt remaining.");
                } else if (maxTry == 1) {
                    System.out.println("You have guess " + "M:" + indexMatch +
                            "; " + "P:" + match);
                    System.out.println("Last attempt!. Good luck");

                } else {
                    System.out.println("Sorry, you failed to guess the number in 8 attempts.");
                    System.out.print("The secret number is: ");
